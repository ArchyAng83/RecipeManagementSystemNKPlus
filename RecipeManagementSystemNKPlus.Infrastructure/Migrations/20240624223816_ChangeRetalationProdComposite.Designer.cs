...
namespace RecipeManagementSystemNKPlus.Infrastructure.Migrations
{
    ...
    [Migration("20240624223816_ChangeRetalationProdComposite")]
    partial class ChangeRetalationProdComposite
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeManagementSystemNKPlus.Domain.Entities.ProductComposite", b =>
                {
                    ...
                    b.HasKey("ProductId", "CompositeId");
            ...
            modelBuilder.Entity("RecipeManagementSystemNKPlus.Domain.Entities.ProductComposite", b =>
                {
                    b.HasOne("RecipeManagementSystemNKPlus.Domain.Entities.Composite", "Composite")
                        .WithMany()
                        .HasForeignKey("CompositeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecipeManagementSystemNKPlus.Domain.Entities.CompositeType", null)
